...
class BetterPlayer extends StatefulWidget {
  const BetterPlayer({Key? key, required this.controller,this.queuePoint,this.controlIcons}) : super(key: key);
  ...
  Widget _buildPlayer() {
    return VisibilityDetector(
      ...
      child: BetterPlayerWithControls(
        controller: widget.controller,queuePoint: widget.queuePoint,controlIcons: widget.controlIcons,
      ),
    );
  }
