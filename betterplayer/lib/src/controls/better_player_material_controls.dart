...
import '../model/control_widget_icons.dart';
...
class _BetterPlayerMaterialControlsState
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    // const Spacer(),
                    // isMobile ? SizedBox() : const Spacer(),
                    // isMobile ? SizedBox() : const Spacer(),
                    // isMobile ? SizedBox() : const Spacer(),
                    // isMobile ? SizedBox() : const Spacer(),
                    // isMobile ? SizedBox() : const Spacer(),
        ...
        child: AnimatedOpacity(
          ...
          child: Container(
            ...
            constraints: const BoxConstraints(
                maxWidth: 24,minWidth: 24,maxHeight: 24,minHeight: 24
            ),
            height: _controlsConfiguration.controlBarHeight,
            ...
            child: Center(
              child: _betterPlayerController!.isFullScreen
                ...
                height: 24,
                width: 24,
                child: widget.controlIcons?.fullscreenDisableIcon,
              )
              ...
              //       )
                ...
                height: 24,
                width: 24,
                child: widget.controlIcons?.fullscreenEnableIcon,
              ),
              // Icon(
              //   _betterPlayerController!.isFullScreen
              //       ? _controlsConfiguration.fullscreenDisableIcon
  ...
  Widget _buildHitAreaClickableButton(
    ...
    return Container(
      constraints: betterPlayerController!.isFullScreen
          ? const BoxConstraints(maxHeight: 80.0, maxWidth: 40.0)
  ...
  Widget _buildSkipButton() {
    return _buildHitAreaClickableButton(
      icon: Container(
          ...
          width: 24,
          height: 24,
          child: widget.controlIcons?.skipBackIcon),
  ...
  Widget _buildForwardButton() {
    return _buildHitAreaClickableButton(
      ...
      Container(
        height: 24,
        width: 24,
        child: widget.controlIcons?.skipForwardIcon,
      ),
              ...
              child: ClipRect(
                child: Container(
                    ...
                    child: (_latestValue != null && _latestValue!.volume > 0)
                        ? Container(
                      child: widget.controlIcons?.unMuteIcon,
                      height: 18,
                      width: 18,
                    )
                        : Container(
                      child: widget.controlIcons?.muteIcon,
                      height: 18,
                      width: 18,
                    )
            ...
            child: SliderTheme(
              ...
              child: Slider(
                ...
                onChanged: (double newValue) {
                  ...
                  try {
                    setState(() {
                      _betterPlayerController?.setVolume(newValue);
                      volume = newValue;
                    });
                  } catch (e) {
                    debugPrint('error during volume::$e');
                  }
                },
  ...
  Widget _buildPlayPause(VideoPlayerController controller) {
    return BetterPlayerMaterialClickableWidget(
      ...
      child: Container(
        ...
        //       )
        Container(
          child: widget.controlIcons?.pauseIcon,
        )
            : Container(
          child: widget.controlIcons?.playIcon,
        ),
      ),
    );
  }
